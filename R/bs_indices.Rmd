...
f1 <- here("species_specific_code", "BS", species, phase, "fit_250_knots.RDS")
if (!file.exists(f1)) {
...
# get predictions
f2 <- here("species_specific_code", "BS", species, phase, "predictions_250_knots.RData")
if (!file.exists(f2)) {
  if(species == "kamchatka_flounder"){
...
f3 <- here("species_specific_code", "BS", species, phase, "indices_250_knots.RData")
if (!file.exists(f3)) {
  if(species == "kamchatka_flounder"){
...
# create ESP products ----
f4 <- here("species_specific_code", "BS", species, phase, "cog_bc.csv")
if (!file.exists(f4)) {
