...
ind_550 <- readRDS(here("species_specific_code", "BS", species, phase, "index_550_knots.RDS")) %>% mutate(n_knots = 550)

load(here("species_specific_code", "BS", species, phase, "indices.RData"))
ind_750 <- ind %>% mutate(n_knots = 750)

indices <- bind_rows(ind_350, ind_450, ind_550, ind_750)
