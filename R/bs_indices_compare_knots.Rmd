...
ind_450 <- readRDS(here("species_specific_code", "BS", species, phase, "index_450_knots.RDS")) %>% mutate(n_knots = 400)
...
indices <- bind_rows(ind_400, ind_450, ind_500, ind_750)
