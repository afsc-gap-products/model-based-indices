...
for(knots in c(250, 350, 500)){ #seq(250, 500, 50)
...
indices <- bind_rows(ind_250, ind_350, ind_500, ind_750) #bind_rows(ind_250, ind_300, ind_350, ind_400, ind_450, ind_500, ind_750)

# plot indices compared among knots
ggplot(indices, aes(x = year, y = est, ymin = lwr, ymax = upr, colour = n_knots)) + 
