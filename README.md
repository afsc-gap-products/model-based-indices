...
| Poisson-link delta-gamma observation model*: <br/> ObsModel = c(2,1) in make_settings()  | option 2: Tweedie ObsModel = c(10,2)^ <br/> option 3: delta-lognormal ObsModel = c(1,1)  |
