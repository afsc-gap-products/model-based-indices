...
author: "Sophia Wassermann and Emily Markowitz"
format:
  html:
...
1.  Switch to the Terminal tab at the bottom of the Rstudio Server window.

2.  Paste in the following text, replacing the email address with your Github email address: `ssh-keygen -t ed25519 -C "your_email@example.com"`
