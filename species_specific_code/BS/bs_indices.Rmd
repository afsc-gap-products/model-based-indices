...
# #TODO: fix matrix package version bug throwing errors in calls to residuals
...
Now, we can compare the index to the prior model and the design-based estimates after making sure you're connected to Oracle db.
