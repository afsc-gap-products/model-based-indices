...
Species <- c("Gadus_macrocephalus","Sebastes_variabilis","Sebastes_polyspinis", "Sebastes_alutus","Gadus_chalcogrammus",
             "Lepidopsetta_polyxystra","Lepidopsetta_bilineata","Lepidopsetta_sp.",
             "Hippoglossoides_elassodon","Atheresthes_stomias")[8] ##change number 1 to select a difference species from the vector
