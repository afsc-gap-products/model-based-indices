...
species_name <- c("Gadus_macrocephalus","Sebastes_variabilis","Sebastes_polyspinis", "Sebastes_alutus","Gadus_chalcogrammus",
             "Lepidopsetta_polyxystra","Lepidopsetta_bilineata","Lepidopsetta sp.",
             "Hippoglossoides_elassodon","Atheresthes_stomias")[2] ##change number 1 to select a difference species from the vector
